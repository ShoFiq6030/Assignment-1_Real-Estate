...
import EamilSVG from "./SVGs/EamilSVG";
              ...
              <htmlForm>
                ...
                <div className="mb-0">
                  <Button
                    ...
                    className={
                      "inline-flex items-center justify-center rounded-md bg-primary px-10 py-3 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-blue-dark"
                    }
                    text={"Send"}
                  />
                </div>
